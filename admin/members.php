...
$rows = '';
$plq = $pdo->prepare("select ".DB_PLAYERS.".*, ".DB_STATS.".rank,  ".DB_STATS.".sefdvn,  ".DB_STATS.".winpot from ".DB_PLAYERS.", ".DB_STATS." where ".DB_PLAYERS.".username = ".DB_STATS.".player order by ".$col." ".$dir. " LIMIT $start, $limit");
$plq->execute();
