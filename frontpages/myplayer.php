...
$opsTheme->addVariable('falsemsj', $falsemessage);
$opsTheme->addVariable('message', $huseltmessage);
$opsTheme->addVariable('user_name', $usr);
$opsTheme->addVariable('user_winnings', money($winnings));
$opsTheme->addVariable('user_sefdvn', money($sefdvn));
...
$details = '';
$details .= $addons->get_hooks(
	array(
		'content' => ''
	),
	array(
    	'page'     => 'myplayer.php',
    	'location' => 'player_details'
	)
);
