...
function automove_after_opponent_timer_js( $array = array() )
{
    ...
    if ($botgod > 0 && $botgod == $player && $autoname != '')
    {
...
function automove_hand0_sql ( $array = array() )
{
    ...
    return "UPDATE " . DB_POKER . " SET msg = '" . $msg . "', lastmove = " . ($time + 1) . " , dealer = {$nxtdeal} $bgsql, move = {$nxtdeal}, bet = 0, lastbet = 0, pot = 0, p1bet = '0', p2bet = '0', p3bet = '0', p4bet = '0', p5bet = '0', p6bet = '0', p7bet = '0', p8bet = '0', p9bet = '0', p10bet = '0', hand = 1  WHERE gameID = " . $gameID . "";
}
$addons->add_hook(array(
