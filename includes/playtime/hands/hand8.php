...
if ($tablebet > $autobet)
{
    ...
    $pdo->query("UPDATE " . DB_POKER . " SET msg = '{$msg}', p{$autoplayer}bet = 'F{$autobet}', move = {$nextup}, hand = 9, lastmove = $timenow  WHERE gameID = " . $gameID);
...
else
{
    ...
    $result = $pdo->query("UPDATE " . DB_POKER . " SET msg = '{$msg}', move = {$nextup}, hand = 9, lastmove = $timenow WHERE gameID = " . $gameID);
